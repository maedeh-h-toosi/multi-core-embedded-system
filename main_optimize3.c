...
int main()
{
  ...
  printf("\nmax_threads %d ", T_max);
  printf("\nthread nnumber %d ", Thread_Number);
  omp_set_num_threads(Thread_Number);
  #pragma omp parallel shared(truePredict, net, test_data, test_label) private(l,p,i)
	{
     //int PV_truePredict=0 ;
    ...
    //#pragma omp critical
    //{
    //  truePredict += PV_truePredict;
    //}
  
    //printf("\nPV_truePredict:  %d ", PV_truePredict);
	}
 //printf("\ntruePredict:  %d ", truePredict); 
